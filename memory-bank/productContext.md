...
- Optionally contribute additional scoped indexes (tags, authors, custom archives) from the site via registered scope builders, without baking those aggregations into the gem.
